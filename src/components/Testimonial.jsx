  ...
  testimonials: [
    {
      ...
      titleRole: "Homeowner",
      quote:
        "Working with arcraft was a dream come true. They truly understood our vision for our dream home and turned it into a stunning reality. Their attention to detail and creativity exceeded our expectation. Working with [Architect's Name] was a dream come true.",
    },
    {
      img: "/images/person-2-min.jpg",
      name: "Alexandra More",
      titleRole: "Interior Design",
      quote:
    ...
    },
    {
      ...
      quote:
        "Collaborating with arcraft on projects has been a rewarding experience. Their ability to seamlessly integrate indoor and outdoor space, creating a harmonius flow, has elevated the overall design and user experience",
    },
  ],
};
        ...
        <div className="lg:flex justify-start lg:justify-center">
          <motion.div
            ...
            <Swiper
              ...
              className="z-50 py-32 mb-7 realtive flex items-center">
        ...
        <motion.div
          ...
          <div className="flex space-x-3">
            <div
              onClick={prevHandler}
              className={`${
                isBeginning == true ? "opacity-30 bg-gray-500 text-gray-600 !cursor-pointer" : "opcaity-100 bg-violet-600 text-white"
              } transition-all duration-300 ease-in-out w-12 h-12 cursor-pointer rounded-full inline-flex justify-center items-center`}>
              <BiChevronLeft
                className={`text-3xl text-primary transition-all duration-300 ease-in-out group-hover:text-white ${
                  isBeginning == true ? "group-hover:!text-gray-600" : "group-hover:text-white"
                }`}
              />
            </div>
            <div
              onClick={nextHandler}
              className={`${
                isEnd == true ? "opacity-30 bg-gray-500 text-gray-600 !cursor-pointer" : "opcaity-100 bg-violet-600 text-white"
              } transition-all duration-300 ease-in-out w-12 h-12 cursor-pointer rounded-full inline-flex justify-center items-center`}>
              <BiChevronRight
                className={`text-3xl text-primary transition-all duration-300 ease-in-out group-hover:text-white ${
                  isEnd == true ? "group-hover:!text-gray-600" : "group-hover:text-white"
                }`}
              />
            </div>
          </div>
