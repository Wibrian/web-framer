    ...
    <>
      <section className={`${className}`}>
        <div className="container px-4 mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 -mb-72 lg:w-10/12 mx-auto">
            {howItWorksContent.steps.map((step, i) => {
              ...
              return (
                <motion.div
                  ...
                  <span className="text-[200px] iniline-block z-[1] font-semibold absolute -top-[120px] opacity-5 left-0 leading-0">
                    {step.number}
                  </span>
                  ...
                  <div className="relative z-40 flex gap-3 items-start">
                    ...
                    <div>
                      <h3 className="text-xl mb-4 duration-300 transition-all ease-in-out group-hover:text-white">{step.title}</h3>
                      ...
                      <p>
                        <Link
                          href={step.btn.href}
                          className="text-[12px] tracking-[2px] uppercase border-b-2 pb-2 inline-block border-violet-600 duration-300 trasition-all ease-in-out group-hover:border-white group-hover:text-white">
                          {step.btn.label}
                        </Link>
                      </p>
                    </div>
                      ...
                      <div>
                        ...
                        <p>
                          <Link
                            ...
                            className="text-[12px] tracking-[2px] uppercase border-b-2 pb-2 inline-block text-white border-white border-opacity-25 duration-300 trasition-all ease-in-out hover:border-opacity-100">
                            {feature.btn.label}
                          </Link>
                        </p>
                      </div>
