...
const aboutContent = {
  ...
  content: {
    img: "/images/hero-min-1-min.jpg",
    title: "Architects of Innovation, Builders of Beauty",
    description:
      "Every structure we conceive tells a unique story, reflecting the aspirations and dream of our clients. From conceptualization to realization, we immerse ourselves in the art of design, striving to capture the essence of each project",
    btn: {
      href: "/about",
...
export default function About({ className }) {
  ...
  const img = useTransform(scrollYProgress, [0, 1], ["30%", "-10%"]);
        ...
        <div className="lg:flex justify-center">
          <div className="lg:w-8/12 lg:flex gap-20 items-center">
            <div className="mb-7 lg:mb-0 lg:w-6/12 lg:order-2 relative">
              <motion.div style={{ y: img }} className="z-[2] relative">
                <Image
